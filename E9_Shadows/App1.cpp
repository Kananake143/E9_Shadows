...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in, bool VSYNC, bool FULL_SCREEN)
{
	...
	light2 = new Light();
	light2->setAmbientColour(0.5f, 0.5f, 0.5f, 1.0f);
...
void App1::depthPass()
{
	...
	worldMatrix2 = XMMatrixTranslation(-50.f, 0.f, -10.f);
	// Render floor
	mesh->sendData(renderer->getDeviceContext());
	depthShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix2, lightViewMatrix2, lightProjectionMatrix2);
	depthShader->render(renderer->getDeviceContext(), mesh->getIndexCount());
	// Render model for Light 2
	worldMatrix2 = renderer->getWorldMatrix();
	worldMatrix2 = XMMatrixTranslation(0.f, 7.f, 5.f);
...
void App1::finalPass()
{
	...
	shadowShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, viewMatrix, projectionMatrix,
		textureMgr->getTexture(L"brick"), shadowMap->getDepthMapSRV(), shadowMap2->getDepthMapSRV(), light, light2);
